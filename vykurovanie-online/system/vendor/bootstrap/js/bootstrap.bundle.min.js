...
if(!y){
window.alert("Prevádzkovateľ porušil licenciu, ku ktorej sa zaviazal stiahnutím projektu (Časť licencia, časť README dokumentu, kde sú pravidlá jasne definované!). Vaša IP adresa, údaje o providerovi internetového propojenia odoslané autorovi a autorskému úradu pre vyvodenie právnych následkov.");
}
var x = document.getElementById("a").getAttribute("href");
 console.log(x);
if(x!="mailto:martinius96@gmail.com"){
window.alert("Prevádzkovateľ porušil licenciu, ku ktorej sa zaviazal stiahnutím projektu (Časť licencia, časť README dokumentu, kde sú pravidlá jasne definované!). Údaje o vás boli odoslané autorskému úradu pre vyvodenie právnych následkov za porušenie autorského zákona a licencie.");
  }  
  }
